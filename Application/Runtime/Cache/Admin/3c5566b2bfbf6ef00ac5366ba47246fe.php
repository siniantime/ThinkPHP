				...
				<div class="login1">
	                ...
	                <div class="login-input">
	                    ...
	                    <p class="yzm ue-clear">
	                        ...
	                        <cite><img style="margin-left: 3px;" onclick="this.src='/ThinkPHP/index.php/Admin/Public/captcha/t/'+Math.random()" src="/ThinkPHP/index.php/Admin/Public/captcha"></cite>
	                    </p>
	                </div>
